...
4. WAS와 웹 서버의 차이점
   ...
   웹 서버란 작성한 HTML 페이지가 네트워크망에 종속되지 않고 웹서비스 되도록 해줍니다. WAS는 웹 서버와 웹 컨테이너를 합친 개념으로, 동적 서버 콘텐츠 수행이 가능하다는 것이 웹 서버와의 가장 큰 차이점입니다.
...
11. Android 생명 주기
12. Android Background / Foreground
...
6. 데이터 마이닝이란 : 데이터 간 상관관계나 새로운 속성 (feature)를 찾는 기법

7. [SVM (Support Vector Machine) 이란](https://jhk0307.tistory.com/112)
